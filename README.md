...
Download the [macOS disk image from the v0.1.2 release](https://github.com/ctemple9/msc2/releases/tag/v0.1.2), open it, and drag MSC 2 into your Applications folder.

### Windows desktop — 64-bit Windows

Download the Windows `.msi` installer from the [v0.1.2 release](https://github.com/ctemple9/msc2/releases/tag/v0.1.2) and follow the installation prompts.

### Debian or Ubuntu desktop

Download the Linux `.deb` package from the [v0.1.2 release](https://github.com/ctemple9/msc2/releases/tag/v0.1.2), then install it with:
...
Download the Linux `.rpm` package from the [v0.1.2 release](https://github.com/ctemple9/msc2/releases/tag/v0.1.2), then install it with:
...
Download the archive and checksum file from the [v0.1.2 release](https://github.com/ctemple9/msc2/releases/tag/v0.1.2), then run:
