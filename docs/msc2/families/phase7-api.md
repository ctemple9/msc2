...
- **Desktop/browser and CLI statuses** stay `Planned` on every row — neither retained client has been repointed at any of these eighteen operations yet (P7.23–P7.26 do that); nothing to ground an `Implemented` cell in today.
