...
**Correction:** The launch test now constructs its expected JAR argument through `Path`, preserving the platform-specific separator that production uses on Windows.
