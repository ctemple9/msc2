...
> **Last updated:** 2026-08-27 (P12.9, P12.10, P12.4k)
...
**Status:** not started
**Files:** `clients/desktop-web/src/lib/sections/server-editor/` (new), `clients/desktop-web/src/App.svelte`, `clients/desktop-web/src/lib/sections/fleet/ManageSheet.svelte`
