...
**Files:** `clients/desktop-web/src/lib/components/base/Menu.svelte` (new), `clients/desktop-web/src/lib/sections/components/ComponentsSection.svelte`, `clients/desktop-web/src/lib/sections/components/ProjectDetailSheet.svelte`, `clients/desktop-web/src/lib/sections/components/model.ts`
