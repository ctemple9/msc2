...
**Status:** awaiting verification (CI run confirmed: `gh run view 30688818826` — `Toolchain (windows-latest)` job, `Test` step, all 5 `secret_store::tests::secret_store_contract_*` PASS, `245 tests run: 245 passed, 0 skipped`)
